              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input type={showPw ? 'text' : 'password'} required minLength={6}
                      ...
                      className="w-full border border-slate-300 rounded-lg px-3 py-2.5 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-charcoal" />
                ...
                <div>
                  ...
                  <input type={showPw ? 'text' : 'password'} required
                    ...
                    className={`w-full border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-charcoal ${
                ...
                <button type="submit" disabled={loading}
                  className="w-full bg-charcoal text-white py-2.5 rounded-lg text-sm font-medium hover:bg-charcoal-deep transition-colors disabled:opacity-60">
